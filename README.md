...
Saboor Ali Khan is a BBA Marketing student at the **Institute of Business Administration (IBA) Karachi** and a **Digital Marketing Intern at 10Pearls Pakistan**. Most of my work sits at the overlap of marketing automation, technical SEO, marketing operations, AI workflows, and the tools that make recurring execution easier to run.

I care about the operating side of digital marketing — the workflows, reporting structures, and internal systems that make campaigns repeatable instead of one-off.
...
- **Digital Marketing Intern at [10Pearls Pakistan](https://10pearls.com)** — marketing automation, technical SEO workflows, and internal systems behind recurring digital marketing execution
- **BBA Marketing, IBA Karachi** (graduating 2026)
- Based in Karachi, Pakistan · available for hybrid and remote marketing-ops / SEO roles post-graduation
...
| Project | What it is |
|---|---|
| [**my-portfolio-2026**](https://github.com/SAK-124/my-portfolio-2026) | Next.js portfolio with topic pages, public tools, rich schema, and an SEO-focused architecture. |
| [**AAMD-Portal**](https://github.com/SAK-124/AAMD-Portal) | Academic workflow portal for the AAMD team — operational reliability and coordination focus. |
| [**iba-ta-hub**](https://github.com/SAK-124/iba-ta-hub) | TA process coordination hub for IBA Karachi. |
...
- n8n vs Zapier vs Make: Picking a Marketing Automation Tool in 2026
- Using AI Workflows to Reduce Repeat Marketing Operations Work
- Building a Resume Builder with Next.js, Supabase, and Real Constraints

---

## 🎯 Current focus

- Marketing automation workflows for recurring outreach and campaign ops
...
If you are hiring for marketing operations, technical SEO, or workflow automation — or you want to collaborate on a small workflow-tool project — the fastest paths are:
